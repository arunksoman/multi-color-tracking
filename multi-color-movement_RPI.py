...
while True:
    ...
    for (lower, upper, colorName) in colorRanges:
        ...
        if len(cnts) > 0:
            ...
            if radius > 100 and colorName == "Green":
                ...
                if not greenDetect:
                    greenDetect = True
                    print("Green detected = ", greenDetect)
                    greenLED(greenDetect)
            elif radius < 100 and colorName == "Green":
                greenDetect = False
                print("Green detected = ", greenDetect)
                greenLED(greenDetect)
                
            if radius > 100 and colorName == "Blue":
                # draw the circle and centroid on the frame,
                # then update the list of tracked points
                ...
                if not blueDetect:
                    blueDetect = True
                    print("Blue detected = ", blueDetect)
                    blueLED(blueDetect)
            elif radius < 100 and colorName == "Blue":
                blueDetect = False
                print("Blue detected = ", blueDetect)
                blueLED(blueDetect)
                
            bothLED(blueDetect,greenDetect)
